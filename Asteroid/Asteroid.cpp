...
{	// thread and argument
	...
	std::thread t(&MakeNoise::playTrack,	// function
		MakeNoise(),						// class
		16382,								// sequence duration (byte multiple)
...
{	// multithreading for music track
	...
	if (game.Construct(r.first/pixel, r.second/pixel, pixel, pixel, true, true, false))
		game.Start();
